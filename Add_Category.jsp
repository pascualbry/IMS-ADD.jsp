...
<body>
  ...
  <div class="testbox">
    ...
    <form action="/IMS/CONTROLLER/Add_Category.jsp">
      ...
      <div class="item">
        <label for="pserial">Category<span>*</span></label>
        <input type="text" name="category" id="pserial" required>
      </div>  
...
%>                
        ...
        <a class="cancel" href="/IMS/INVENTORY/Category.jsp">Cancel</a>
