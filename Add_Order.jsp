...
<body>
  ...
  <div class="testbox">
    ...
    <form action="/IMS/CONTROLLER/Add_Order.jsp?">
...
%>
		      ...
		      <div class="item">
		        ...
		        <input type="number" value="0" id="QUANTITY1" onchange="Total()" name="quantity1" step="1" min="1" max="20" required>    	      
		      </div></td><td>
         ...
         <tr><td>
          <label>Product<span>*</span></label>
              <select id="GFG2" onchange="Product()">
                <option selected value="" disabled selected class="city">---SELECT---</option>
<%
...
%>
		      ...
		      <div class="item">
		        <label>Quantity<span>*</span></label>
		        <input type="number" value="0" id="QUANTITY2" onchange="Total()" name="quantity2" step="1" min="0" max="20">
		      </div></td><td>
         ...
         <tr><td>
          <label>Product<span>*</span></label>
              <select id="GFG3" onchange="Product()">
                <option selected value="" disabled selected class="city">---SELECT---</option>
<%
...
%>
		      ...
		      <div class="item">
		        <label>Quantity<span>*</span></label>
		        <input type="number" value="0" id="QUANTITY3" onchange="Total()" name="quantity3" step="1" min="0" max="20">
		      </div></td><td>
      ...
      <div class="item">
        <label>13% VAT<span>*</span></label>
        <input type="number" id="vat" name="vat" readonly="readonly">
      </div>   
		      
      <div class="item">
        <label>Final Total<span>*</span></label>
        <input type="number" id="finalTotal" name="finalTotal" readonly="readonly">
      </div>   
